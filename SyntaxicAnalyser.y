...
MainHead               : ClassHead BRACE_OPEN KEYWORD_PUBLIC KEYWORD_MAIN{ g_type = tVoid; verifierFoncID("main"); } PARENTHESE_OPEN TYPE_STRING {g_type = tString;}BRACKET_OPEN BRACKET_CLOSE
                       ...
                       ;
MainBody               : IDENTIFIER{ verifierVarID(nom);} PARENTHESE_CLOSE { foncDecEnd(); } BRACE_OPEN StatementS  BRACE_CLOSE {finFonction();} MethodDeclarationS BRACE_CLOSE {finClass();tabCodeInt[indextab]=createCode("SORTIE");indextab++;}
                       ;
...
Statement              : BRACE_OPEN StatementS BRACE_CLOSE
                       ...
                       | VarDeclaration
                       | KEYWORD_IF PARENTHESE_OPEN Expression PARENTHESE_CLOSE {tabCodeInt[indextab]=createCode("SIFAUX");indexIf=indextab;indextab++;}
                            BRACE_OPEN StatementS BRACE_CLOSE {tabCodeInt[indextab]=createCode("SAUT");indextab++;tabCodeInt[indexIf].operand=indextab;indexIf=indextab-1;}
                            KEYWORD_ELSE BRACE_OPEN StatementS BRACE_CLOSE {tabCodeInt[indexIf].operand=indextab;}
                       ...
                       | KEYWORD_WHILE {indexWhile1=indextab;} PARENTHESE_OPEN Expression PARENTHESE_CLOSE {tabCodeInt[indextab]=createCode("TANTQUEFAUX");indexWhile2=indextab;indextab++;}
                            BRACE_OPEN StatementS BRACE_CLOSE {tabCodeInt[indextab]=createOperation("TANTQUE",indexWhile1);indextab++;tabCodeInt[indexWhile2].operand=indextab;}
                       ...
                       | Identifieraff OP_AFFECT Expression SEMI_COLON {tabCodeInt[indextab]=createOperation("STORE",getAddress(nomaff,table_local));indextab++;}
                       ...
                       ;
Expression             : INTEGER_LITERAL {tabCodeInt[indextab]=createOperation("LDC",numval);indextab++;}ExpressionComp
                       ...
                       ;
ExpressionComp         : Operator Expression {tabCodeInt[indextab]=createCode(oper);indextab++;} ExpressionComp
                       | Logic Expression {tabCodeInt[indextab]=createCode(oper);indextab++;} ExpressionComp
...
Identifier             : IDENTIFIER
                       ;
Identifierexp          : IDENTIFIER {checkID(nom);tabCodeInt[indextab]=createOperation("LDV",getAddress(nom,table_local));indextab++;}
                       ;
